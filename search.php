<?php 
    ...
    $result = $mysqli->query("SELECT id, name,imgUrl, ingredient, recette,videoUrl,category FROM recette WHERE name LIKE '%$q%'");
                        ...
                        <nav class="navbar navbar-expand-lg bg-body-tertiary">
                            <div class="container">
                                ...
                                <form class="d-flex" role="search" action='search.php'>
                                    ...
                                    <input class="btn btn-outline-success custom_button_search" type="submit" value="Rechercher"></input>
                                </form>
                                </div>
                            </div>
                        </nav>
