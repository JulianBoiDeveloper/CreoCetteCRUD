 <?php 
    ...
    $result = $mysqli->query("SELECT id, name,imgUrl, ingredient, recette,videoUrl,category FROM recette");
...
<html lang="fr">
    <head>
        ...
        <title>Cuisine Creole - Accueil</title>
                        ...
                        <nav class="navbar navbar-expand-lg bg-body-tertiary">
                            <div class="container">
                                ...
                                <form class="d-flex" role="search" action='search.php'>
                                    <input class="form-control me-2 custom_search" type="search" placeholder="Recherche..." aria-label="Search" name="q">
                                    <input class="btn btn-outline-success custom_button_search" type="submit" value="Rechercher">
                                </form>
                                </div>
                            </div>
                        </nav>
            ...
            <div class="modal-dialog">
                <div class="modal-content custom_login">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="loginModalLabelConnect">Connectez-vous</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="mail-login" class="form-label">Adresse mail</label>
                            <input name="email" type="email" class="form-control" id="mail-login" placeholder="name@example.com">
                        </div>
                        <div class="mb-3">
                            <label for="password-login" class="col-form-label">Mot de passe</label>
     ...
     <form action="controller/register.php" method="post">
        <div class="modal fade" id="registerModal" tabindex="-1" aria-labelledby="registerModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content custom_login">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="loginModalLabelSave">Enregister-vous</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="user-register" class="form-label">Nom d'utilisateur</label>
                            <input name="username" type="text" class="form-control" id="user-register" placeholder="">
                        </div>
                        <div class="mb-3">
                            <label for="mail-register" class="form-label">Adresse mail</label>
                            <input name="email" type="email" class="form-control" id="mail-register" placeholder="name@example.com">
                        </div>
                        <div class="mb-3">
                            <label for="password-register" class="col-form-label">Mot de passe</label>
                            <input name="password" type="password" class="form-control" id="password-register">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermé</button>
    ...
    <div class="container text-center">
        ...
        <?php 
            for($i=0;$i<count($rows);$i++){
                echo '
                <a class="custom_a" href="recette.php?id='.$rows[$i]['id'].'">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="recetteName" class="form-control" id="exampleFormControlInput1" placeholder="" required>
                            <label class="form-label">Catégorie</label>
                            <select class="form-select" required="required" name="categorie">
                                <option value="">Choisie ta catégorie</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="file" name="formFile" accept=".png,.jpeg,.jpg">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Vidéo</label>
                                <input class="form-control" type="file" name="formVideo" accept=".mp4,.avi">
                            </div> 
                            ...
                            <label for="exampleFormControlTextarea1" class="form-label">Recettes</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"  name="recette" required="required"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                        <input type="submit" class="btn btn-primary" value="Ajouter cette Creo'Cette">
                    </div>
                </div>
            </div>
        </div>
