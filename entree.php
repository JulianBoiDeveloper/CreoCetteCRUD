...
$result = $mysqli->query("SELECT id, name,imgUrl, ingredient, recette,videoUrl,category FROM recette WHERE category=0 OR category=1");
...
<html lang="fr">
    <head>
        ...
        <title>Cuisine Creole - Entrée</title>
                        ...
                        <nav class="navbar navbar-expand-lg bg-body-tertiary">
                            <div class="container">
                                ...
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#">Entrée</a>
                                    </li>
                                    <li class="nav-item">
